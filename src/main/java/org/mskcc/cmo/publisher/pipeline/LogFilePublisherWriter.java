 ...
 * @author ochoaa
 */
public class LogFilePublisherWriter implements ItemStreamWriter<Map<String, String>> {
    @Autowired
    private Gateway messagingGateway;

    private static final Log LOG = LogFactory.getLog(LogFilePublisherWriter.class);
